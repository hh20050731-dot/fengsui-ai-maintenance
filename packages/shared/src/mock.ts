...
export function createMockWorkOrders(): WorkOrder[] {
  return [
    { workOrderId: 'WO-20260716-003', sourceAlertId: 'ALT-20260716-003', deviceId: 'LTP-001', deviceName: '渗滤液处理泵', riskLevel: '高风险', faultDescription: '出口压力异常并伴随机械密封渗漏', maintenanceSuggestion: ['执行安全隔离', '拆检机械密封和泵体'], assignee: '马工', assigneeUserId: 'ma-gong', createdBy: '黄浩', createdTime: ago(18), deadline: ago(-6), requiredSpareParts: [{ partId: 'SP-004', partName: '机械密封件', quantity: 1, unit: '套' }], consumedSpareParts: [], processingRecord: [{ id: 'REC-001', time: ago(18), operator: '马工', action: '开始检修', detail: '已完成停电、泄压和挂牌上锁' }], healthScoreBefore: 55, status: '检修中' },
    { workOrderId: 'WO-20260715-002', sourceAlertId: 'ALT-20260715-004', deviceId: 'ACP-001', deviceName: '空压机', riskLevel: '关注', faultDescription: '排气温度持续偏高', maintenanceSuggestion: ['清洁冷却器', '检查润滑油'], assignee: '孙工', assigneeUserId: 'sun-gong', createdBy: '黄浩', createdTime: ago(38), deadline: ago(-34), requiredSpareParts: [{ partId: 'SP-002', partName: '通用润滑油', quantity: 1, unit: '桶' }], consumedSpareParts: [], processingRecord: [], healthScoreBefore: 84, status: '已接单' },
    { workOrderId: 'WO-20260713-001', deviceId: 'CWP-001', deviceName: '1号循环水泵', riskLevel: '关注', faultDescription: '计划性润滑检查', maintenanceSuggestion: ['检查轴承润滑状态'], assignee: '王工', assigneeUserId: 'wang-gong', createdBy: '王工', createdTime: ago(96), deadline: ago(24), requiredSpareParts: [], consumedSpareParts: [], processingRecord: [], healthScoreBefore: 91, status: '待接单' },
  ];
}
