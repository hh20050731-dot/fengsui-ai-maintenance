...
export const faultScenarios: Record<FaultScenarioId, FaultScenario> = {
  normal: {
    ...
    faultPart: '无明确故障部位', targetPart: null, highlightColor: '#78909c',
  ...
  'impeller-imbalance': {
    ...
    faultPart: '叶轮 / 转子', targetPart: 'impeller', highlightColor: '#c56a3a',
  ...
  'bearing-overheat': {
    ...
    faultPart: '驱动端轴承', targetPart: 'bearing', highlightColor: '#b94a48',
  ...
  'coupling-misalignment': {
    ...
    faultPart: '联轴器 / 轴系', targetPart: 'coupling', highlightColor: '#b94a48',
